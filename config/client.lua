return {
    currency = '$',
    mods = {
        {id = 0,  label = 'Spoiler',              category = 'parts', icon = 'spoiler'},
        {id = 1,  label = 'Front Bumper',         category = 'parts', icon = 'bumper-front'},
        {id = 2,  label = 'Rear Bumper',          category = 'parts', icon = 'bumper-rear'},
        {id = 3,  label = 'Side Skirt',           category = 'parts', icon = 'skirt'},
        {id = 4,  label = 'Exhaust',              category = 'parts', icon = 'exhaust'},
        {id = 5,  label = 'Roll Cage',            category = 'parts', icon = 'cage'},
        {id = 6,  label = 'Grille',               category = 'parts', icon = 'grille'},
        {id = 7,  label = 'Hood',                 category = 'parts', icon = 'hood'},
        {id = 8,  label = 'Left Fender',          category = 'parts', icon = 'fender-left'},
        {id = 9,  label = 'Right Fender',         category = 'parts', icon = 'fender-right'},
        {id = 10, label = 'Roof',                 category = 'parts', icon = 'roof'},
        {id = 11, label = 'Engine Upgrade',       category = 'performance', icon = 'engine'},
        {id = 12, label = 'Brake Upgrade',        category = 'performance', icon = 'brakes'},
        {id = 13, label = 'Transmission Upgrade', category = 'performance', icon = 'transmission'},
        {id = 14, label = 'Horns',                category = 'parts', icon = 'horns'},
        {id = 15, label = 'Suspension Upgrade',   category = 'performance', icon = 'suspension'},
        {id = 16, label = 'Armor Upgrade',        category = 'performance', enabled = false, icon = 'armor'},
        {id = 17, label = 'Nitrous',              category = 'performance', enabled = false, icon = 'nitrous'},
        {id = 18, label = 'Turbo Upgrade',        category = 'performance', icon = 'turbo'},
        {id = 19, label = 'Subwoofer',            category = 'parts', icon = 'subwoofer'},
        -- {id = 20, label = 'Tyre smoke',                category = 'colors'},
        {id = 21, label = 'Hydraulics',           category = 'parts', icon = 'hydraulics'},
        ...
        {id = 25, label = 'Plate holder',         category = 'parts', icon = 'plate'},
        {id = 26, label = 'Vanity Plates',        category = 'parts', icon = 'vanity'},
        {id = 27, label = 'Trim A',               category = 'parts', icon = 'trim'},
        {id = 28, label = 'Ornaments',            category = 'parts', icon = 'ornament'},
        {id = 29, label = 'Dashboard',            category = 'parts', icon = 'dashboard'},
        {id = 30, label = 'Dial',                 category = 'parts', icon = 'dial'},
        {id = 31, label = 'Door Speaker',         category = 'parts', icon = 'door-speaker'},
        {id = 32, label = 'Seats',                category = 'parts', icon = 'seats'},
        {id = 33, label = 'Steering Wheel',       category = 'parts', icon = 'steering'},
        {id = 34, label = 'Shifter Leaver',       category = 'parts', icon = 'shifter'},
        {id = 35, label = 'Plaque',               category = 'parts', icon = 'plaque'},
        {id = 36, label = 'Speaker',              category = 'parts', icon = 'speaker'},
        {id = 37, label = 'Trunk',                category = 'parts', icon = 'trunk'},
        {id = 38, label = 'Hydraulic',            category = 'parts', icon = 'hydraulics'},
        {id = 39, label = 'Engine Block',         category = 'parts', icon = 'engine-block'},
        {id = 40, label = 'Air Filter',           category = 'parts', icon = 'filter'},
        {id = 41, label = 'Strut',                category = 'parts', icon = 'strut'},
        {id = 42, label = 'Arch Cover',           category = 'parts', icon = 'arch'},
        {id = 43, label = 'Aerial',               category = 'parts', icon = 'aerial'},
        {id = 44, label = 'Trim B',               category = 'parts', icon = 'trim-b'},
        {id = 45, label = 'Fuel Tank',            category = 'parts', icon = 'fuel'},
        {id = 46, label = 'Left door',            category = 'parts', icon = 'door'},
        {id = 47, label = 'Right door',           category = 'parts', icon = 'door'},
        -- {id = 48, label = 'Livery',               category = 'colors'},
        {id = 49, label = 'Lightbar',             category = 'parts', icon = 'lightbar'},
    },
